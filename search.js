...
searchFile(customerPath, ['Kata Sandi', 'Bayar di Toko', 'Cash', 'checkoutPaymentMethod', 'Ubah Password', 'profilePassword']);
searchFile(adminPath, ['Menunggu Pembayaran di Toko', 'Bayar di Toko', 'Cash', 'Invoice']);
