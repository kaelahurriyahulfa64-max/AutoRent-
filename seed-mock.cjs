...
const payments = `[
  { id: 'PAY-J1', bookingId: 'BR-101', nominal: 5000000, metode: 'Transfer', status: 'Berhasil', tanggalBayar: '2026-01-09T10:05', tipe: 'Pelunasan' },
  { id: 'PAY-J2', bookingId: 'BR-101', nominal: 3000000, metode: 'Transfer', status: 'Berhasil', tanggalBayar: '2026-01-09T10:06', tipe: 'Pelunasan' },

  { id: 'PAY-F1', bookingId: 'BR-102', nominal: 6000000, metode: 'Transfer', status: 'Berhasil', tanggalBayar: '2026-02-14T10:05', tipe: 'Pelunasan' },
  { id: 'PAY-F2', bookingId: 'BR-102', nominal: 4000000, metode: 'Transfer', status: 'Berhasil', tanggalBayar: '2026-02-14T10:06', tipe: 'Pelunasan' },

  { id: 'PAY-M1', bookingId: 'BR-103', nominal: 7000000, metode: 'Transfer', status: 'Berhasil', tanggalBayar: '2026-03-19T10:05', tipe: 'Pelunasan' },
  { id: 'PAY-M2', bookingId: 'BR-103', nominal: 5000000, metode: 'Transfer', status: 'Berhasil', tanggalBayar: '2026-03-19T10:06', tipe: 'Pelunasan' },

  { id: 'PAY-A1', bookingId: 'BR-104', nominal: 9000000, metode: 'Transfer', status: 'Berhasil', tanggalBayar: '2026-04-04T10:05', tipe: 'Pelunasan' },
  { id: 'PAY-A2', bookingId: 'BR-104', nominal: 6000000, metode: 'Transfer', status: 'Berhasil', tanggalBayar: '2026-04-04T10:06', tipe: 'Pelunasan' },

  { id: 'PAY-Y1', bookingId: 'BR-003', nominal: 12000000, metode: 'Transfer', status: 'Berhasil', tanggalBayar: '2026-05-09T10:05', tipe: 'Pelunasan' },
  { id: 'PAY-Y2', bookingId: 'BR-003', nominal: 6000000, metode: 'Transfer', status: 'Berhasil', tanggalBayar: '2026-05-09T10:06', tipe: 'Pelunasan' },

  { id: 'PAY-JN1', bookingId: 'BR-001', nominal: 2400000, metode: 'Transfer', status: 'Berhasil', tanggalBayar: '2026-06-15T10:05', tipe: 'DP' },
  { id: 'PAY-JN2', bookingId: 'BR-002', nominal: 1500000, metode: 'Transfer', status: 'Berhasil', tanggalBayar: '2026-06-15T11:05', tipe: 'DP' },
  { id: 'PAY-JN3', bookingId: 'BR-115', nominal: 1000000, metode: 'Transfer', status: 'Berhasil', tanggalBayar: '2026-06-15T12:05', tipe: 'DP' },
  { id: 'PAY-JN4', bookingId: 'BR-106', nominal: 3000000, metode: 'Transfer', status: 'Berhasil', tanggalBayar: '2026-06-14T10:05', tipe: 'Pelunasan' },
  { id: 'PAY-JN5', bookingId: 'BR-107', nominal: 4000000, metode: 'Transfer', status: 'Berhasil', tanggalBayar: '2026-06-15T10:05', tipe: 'Pelunasan' },
  { id: 'PAY-JN6', bookingId: 'BR-116', nominal: 2000000, metode: 'Cash', status: 'Berhasil', tanggalBayar: '2026-06-16T10:00', tipe: 'Pelunasan' },
  { id: 'PAY-JN7', bookingId: 'BR-117', nominal: 2500000, metode: 'Cash', status: 'Berhasil', tanggalBayar: '2026-06-16T14:55', tipe: 'Pelunasan' },
  { id: 'PAY-JN8', bookingId: 'BR-007', nominal: 2000000, metode: 'Transfer', status: 'Berhasil', tanggalBayar: '2026-06-09T10:05', tipe: 'Pelunasan' },
  { id: 'PAY-JN9', bookingId: 'BR-009', nominal: 2800000, metode: 'Transfer', status: 'Berhasil', tanggalBayar: '2026-06-04T10:05', tipe: 'Pelunasan' }, 
  { id: 'PAY-F-007', bookingId: 'BR-007', nominal: 200000, metode: 'Transfer', status: 'Berhasil', tanggalBayar: '2026-06-13T10:05', tipe: 'Denda' },
  { id: 'PAY-F-009', bookingId: 'BR-009', nominal: 600000, metode: 'Transfer', status: 'Berhasil', tanggalBayar: '2026-06-11T10:05', tipe: 'Denda' }
]`;
...
content = content.replace(/export const INITIAL_BOOKINGS: Booking\[\] = \[\];/, 'export const INITIAL_BOOKINGS: Booking[] = ' + bookings + ';');
content = content.replace(/export const INITIAL_PAYMENTS: Pembayaran\[\] = \[\];/, 'export const INITIAL_PAYMENTS: Pembayaran[] = ' + payments + ';');
content = content.replace(/export const INITIAL_INVOICES: Invoice\[\] = \[\];/, 'export const INITIAL_INVOICES: Invoice[] = ' + invoices + ';');
content = content.replace(/export const INITIAL_MAINTENANCE: MaintenanceRecord\[\] = \[\];/, 'export const INITIAL_MAINTENANCE: MaintenanceRecord[] = ' + maintenance + ';');
content = content.replace(/export const INITIAL_REFUNDS: Refund\[\] = \[\];/, 'export const INITIAL_REFUNDS: Refund[] = ' + refunds + ';');
content = content.replace(/export const INITIAL_NOTIFICATIONS: AppNotification\[\] = \[\];/, 'export const INITIAL_NOTIFICATIONS: AppNotification[] = ' + notifications + ';');
content = content.replace(/'autorent_initialized', 'v7'/g, "'autorent_initialized', 'v8'");
content = content.replace(/'autorent_initialized' === 'v7'/g, "'autorent_initialized' === 'v8'");
content = content.replace(/'v7'/g, "'v8'"); 

fs.writeFileSync(dataFile, content);

console.log('Mock data injected and version updated to v8!');
